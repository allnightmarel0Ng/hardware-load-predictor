...
class ForecastResult(Base):
    ...
    predicted_ram_percent:     Mapped[float] = mapped_column(Float, nullable=False)
    predicted_network_mbps:    Mapped[float] = mapped_column(Float, nullable=False)
    predicted_disk_io_percent: Mapped[float] = mapped_column(Float, nullable=False)
    ...
    lower_ram_percent:         Mapped[float | None] = mapped_column(Float, nullable=True)
    lower_network_mbps:        Mapped[float | None] = mapped_column(Float, nullable=True)
    lower_disk_io_percent:     Mapped[float | None] = mapped_column(Float, nullable=True)
    ...
    upper_ram_percent:         Mapped[float | None] = mapped_column(Float, nullable=True)
    upper_network_mbps:        Mapped[float | None] = mapped_column(Float, nullable=True)
    upper_disk_io_percent:     Mapped[float | None] = mapped_column(Float, nullable=True)
    # Actuals — back-filled by the accuracy monitor
    ...
    actual_ram_percent:        Mapped[float | None] = mapped_column(Float, nullable=True)
    actual_network_mbps:       Mapped[float | None] = mapped_column(Float, nullable=True)
    actual_disk_io_percent:    Mapped[float | None] = mapped_column(Float, nullable=True)
...
class ModelEvaluation(Base):
    ...
    mae_ram_gb:  Mapped[float | None] = mapped_column(Float, nullable=True)
    mae_ram_pct: Mapped[float | None] = mapped_column(Float, nullable=True)
    mae_net:     Mapped[float | None] = mapped_column(Float, nullable=True)
    mae_disk:    Mapped[float | None] = mapped_column(Float, nullable=True)
    rmse_cpu:    Mapped[float | None] = mapped_column(Float, nullable=True)
    rmse_ram_gb: Mapped[float | None] = mapped_column(Float, nullable=True)
    rmse_ram_pct:Mapped[float | None] = mapped_column(Float, nullable=True)
    rmse_net:    Mapped[float | None] = mapped_column(Float, nullable=True)
    rmse_disk:   Mapped[float | None] = mapped_column(Float, nullable=True)
    ...
    r2_ram_gb:   Mapped[float | None] = mapped_column(Float, nullable=True)
    r2_ram_pct:  Mapped[float | None] = mapped_column(Float, nullable=True)
    r2_net:      Mapped[float | None] = mapped_column(Float, nullable=True)
    r2_disk:     Mapped[float | None] = mapped_column(Float, nullable=True)
